...
class NosotrosActivity : AppCompatActivity()  {
    ...
    lateinit var btnReturnSomos : ImageButton
    lateinit var btnReturnMenu : Button

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.somos_main)
        ...
        btnReturnSomos = findViewById(R.id.btnReturnSomos)
        btnReturnMenu = findViewById(R.id.btnMenuNosotros)

        btnReturnSomos.setOnClickListener {
